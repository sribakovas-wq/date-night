...
/* PAPRASTAS IR PATIKIMAS MYGTUKAS: 1 CLICK = 1 PERĖJIMAS */
let lastNextClick=0;

function goNext(){
 const now=Date.now();

 // Apsauga tik nuo netyčinio dvigubo paspaudimo.
 if(now-lastNextClick<350)return;
 lastNextClick=now;
...
/* Naudojame tik CLICK — jokių pointerup/touchstart ant mygtuko. */
